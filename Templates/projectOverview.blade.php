                                                        ...
                                                        <div class="btn-group priority">
                                                            <button type="button" id="priority-ticket-{{ $row->id }}"
                                                                ...
                                                                @if (is_numeric($row->priority) && isset($userViewsData->allPriorities[$row->priority]))
                                                                    <span id="priority-label">{!! $userViewsData->allPriorities[$row->priority] !!}</span>
                                                                    <i class="fa fa-caret-down"></i>
                                                                @endif
                ...
                <script>
                    jQuery(function() {
                        jQuery("#projectOverviewTabs").tabs({
                            @if (isset($userViewsData->selectedView) && in_array($userViewsData->selectedView, array_keys($userViewsData->userViews)))
                                active: {{ array_search($userViewsData->selectedView, array_keys($userViewsData->userViews)) }},
                            @endif
                            activate: function() {
